...
def Login(root, mainFrame):
    ...
    Button(mainFrame, text = "Cancelar", bg="#893894", width = 13, height = 3, relief="flat",fg="#FFFEFD",font=("Inter", 15,"bold"), command = lambda: log.LOG(root, mainFrame)).place(x = 110, y = 510)